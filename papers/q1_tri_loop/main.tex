...
The plant under study is a $125.4\,$kWp grid-tied PV array
($228$ Chint Astro~5 Semi $550\,$Wp modules), a 50\,kWh /
60\,kW lithium-ion BESS, and a single three-phase voltage-source
inverter behind an LCL filter. The model parameters mirror a real
distribution-feeder rooftop installation in Winongo, Kota Madiun,
East Java, Indonesia (Fig.~\ref{fig:plant_real}; $7.613^\circ$S,
$111.512^\circ$E), which also drives the Madiun case study in
