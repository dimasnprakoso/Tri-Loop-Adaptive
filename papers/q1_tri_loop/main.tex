...
The plant under study is the $125.4\,$kWp grid-tied rooftop
...
calibrated to the same $125.4\,$kWp STC rating; this installation
...
Fig.~\ref{fig:plant_install} captures the module-handling phase of
the rooftop array during commissioning;
Fig.~\ref{fig:plant_overview} shows the completed system under
typical tropical clear-sky irradiance. The site sits at the end of a
distribution feeder characterised by intermittent cloud cover, low
residual rotational inertia, and strong diurnal load--temperature
coupling---precisely the operating regime in which the limit-cycle
phenomenon identified in this paper turns from a theoretical
curiosity into a tangible design constraint.
