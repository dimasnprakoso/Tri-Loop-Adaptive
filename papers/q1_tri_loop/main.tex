...
voltage-source inverter behind an LCL filter. The PV array is
represented in the simulation by a single-diode aggregate equivalent
calibrated to the same $125\,$kWp STC rating; this installation
also drives the Madiun case study in
Section~\ref{sec:results-madiun}. The $125\,$kW rating places the
